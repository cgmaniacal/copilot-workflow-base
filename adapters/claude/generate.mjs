 ...
 *
 * @param {string} workflowContent - Contents of core/workflow.md
...
function buildClaudeMd(workflowContent, agentDocsDir, detectedStacks) {
  ...
  sections.push('<!-- Re-run the Claude adapter after editing agent_docs to update this file. -->');
  sections.push('');
  ...
  // Model routing table — Claude Code specific
  sections.push('---');
  sections.push('');
...
export function generateClaudeConfig(targetDir, coreDir, agentDocsDir, detectedStacks = []) {
  ...
  const claudeMdContent = buildClaudeMd(workflowContent, agentDocsDir, detectedStacks);
